...
<div class="pop-delete order">
    <div class="reason-cancel">
        ...
        <div class="note-reason">
            <label class="cancel">
                <input type="radio" id="1" name="reason" value="Đổi ý, không mua nữa"> Đổi ý, không mua nữa
            </label><br><br>

            <label class="findanother">
                <input type="radio" name="reason" value="Tìm thấy giá rẻ hơn ở chỗ khác"> Tìm thấy giá rẻ hơn ở chỗ khác
            </label><br><br>

            <label class="changeproduct">
                <input type="radio" name="reason" value="Muốn thay đổi sản phẩm trong đơn hàng (màu sắc, số lượng,...)"> Muốn thay đổi sản phẩm trong đơn hàng (màu sắc, số lượng,...)
            </label><br><br>
